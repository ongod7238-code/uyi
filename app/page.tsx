  ...
  return <SiteShell>
    <main>
      <section className="relative overflow-hidden bg-[#1e1c1a] text-white">
        ...
        <div className="relative mx-auto flex min-h-[62svh] sm:min-h-[85svh] md:min-h-[100svh] max-w-[1600px] flex-row px-5 pt-20 sm:px-8 md:px-10 md:pt-28 lg:px-14 lg:pt-32">
          <div className="relative z-10 flex w-[58%] md:w-[62%] max-w-3xl flex-col justify-center pb-8 sm:pb-12 lg:w-[58%] lg:pb-20">
          ...
          <div className="relative z-0 w-[42%] md:w-[38%] lg:w-[42%]">
            <Image src={portrait} alt="Uyi-Osa Degarson" fill priority sizes="(max-width: 767px) 42vw, (max-width: 1024px) 38vw, 42vw" className="object-cover object-[center_18%] sm:object-[center_16%] lg:object-[center_20%]" />
          </div>
